...
- Load MaxMind databases into memory instead of memory-mapping them, preventing a SIGBUS crash when the database file is overwritten in place on disk while Caddy is running ([#30](https://github.com/anujc4/caddy-geoblock/issues/30))
...
[Unreleased]: https://github.com/anujc4/caddy-geoblock/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/anujc4/caddy-geoblock/compare/v0.1.1...v0.1.2
